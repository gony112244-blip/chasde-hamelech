export default {
    ...
    author_gony_p1: 'Pendant des années, j\'ai vu David et Avitar — des gars bien qui sortent semaine après semaine, s\'organisent eux-mêmes et distribuent aux enfants hospitalisés. Cela m\'a semblé être l\'une des choses les plus pures que l\'on puisse faire.',
    author_gony_p2: 'Une idée nous est venue: même si je n\'étais pas capable d\'être en première ligne, je pouvais donner mon livre. "Sar HaTzava" traite de faire face aux difficultés — de petites mains contre les murs blêmes d\'un hôpital, et le monde de l\'imagination qui les emmène vers des endroits plus élevés.',
    author_gony_p3: 'Une fois que j\'ai compris que ça faisait une différence, j\'ai décidé de donner autant de livres que possible. Car un livre a un pouvoir qui ne peut être quantifié.',
