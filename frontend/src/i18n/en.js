export default {
    ...
    help_donate_desc: 'Donations are intended for purchasing games and books for hospitalized children',
    ...
    how_donate_desc: 'A monetary gift helps buy games and books for hospitalized children',
    ...
    author_quote_gony: 'When a sick child smiles and sails in imagination into a story of heroism — it gives them more strength to keep fighting, on the way to the true victory: complete health and healing close at hand.',
    author_corner_label: "Author's Corner",
    author_corner_heading: "Author's Corner | Gony Shmukha",
    ...
    author_gony_p1: 'For years I have been privileged to watch from the sidelines this quiet work of kindness. Week after week, without noise or fanfare, dear people simply get up and do: they organize, pack, and bring light to children confined between the pale walls of hospital wards. To me, this is the definition of pure kindness, and I am full of gratitude for the privilege of standing beside them.',
    author_gony_p2: 'When I searched for how I could contribute my small part to this blessed work, I understood that the simple tool in my hands is the story. My book, "Sar HaTzava", tells of a warrior standing against a dark and mighty sorcerer. It is a story of an impossible struggle, of willpower, and of the ability to find inner strength even when the odds seem slim.',
    author_gony_p3: 'With God\'s help, when we have the opportunity to give the book to a child in the hospital, for a moment they receive something beyond the medical world; they gain a world of imagination. The book takes those small hands and carries them far beyond the ward walls, to realms of heroism. It reminds them of the warrior within and gives them a little more strength to stand firm in the battle.',
    author_gony_p4: 'Our role is only to be the small messengers who give them a tool to get through these days, with a deep prayer that these books and smiles will give them strength to endure, until the true and complete victory.',
