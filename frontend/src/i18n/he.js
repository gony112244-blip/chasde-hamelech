export default {
    ...
    hero_desc: 'יוזמת חסדי המלך מחלקת מתנות לילדים, צעצועים וספרים. אנו מחלקים בבתי חולים בכל רחבי הארץ כדי לשמח ילדים מאושפזים ולהחזיר להם את החיוך.',
    ...
    help_donate_desc: 'התרומות מיועדות לרכישת משחקים וספרים לילדים מאושפזים',
    ...
    thankyou_success_msg: 'ההודעה התקבלה ותפורסם בקיר התודה לאחר אישור המנהל. 💛',
    thankyou_success_msg_photo: 'ההודעה עם התמונה התקבלה ותפורסם בקיר התודה לאחר אישור המנהל.',
    ...
    // Footer
    footer_about: 'יוזמת חסדי המלך מחלקת מתנות לילדים, צעצועים ומשחקים. אנו מחלקים בבתי חולים ברחבי ישראל ומחזירים את החיוך לגיבורים הקטנים.',
    ...
    // AboutSection
    about_mission_desc: 'ילדים מאושפזים מפספסים את הילדות. יוזמת חסדי המלך מחלקת מתנות לילדים, צעצועים וספרים בבתי חולים ברחבי הארץ. צוות המתנדבים שלנו מחלק בבתי חולים מדי שבוע כדי להחזיר להם רגעים של שמחה וחיוך.',
    ...
    how_donate_desc: 'תרומה כספית מסייעת לרכוש משחקים וספרים לילדים מאושפזים',
    ...
    author_quote_gony: 'כשילד חולה מחייך ומפליג בדמיון אל תוך סיפור של גבורה — זה נותן לו עוד כוח להילחם, בדרך לניצחון האמיתי: בריאות שלמה ורפואה קרובה.',
    author_corner_label: 'פינת הסופר',
    author_corner_heading: 'פינת הסופר | גוני שמוחה',
    ...
    author_gony_p1: 'במשך שנים אני זוכה לראות מהצד את מפעל החסד השקט הזה. שבוע אחר שבוע, בלי רעש וצלצולים, קמים אנשים יקרים ופשוט עושים: מארגנים, אורזים ומביאים אור לילדים שכלואים בין קירות חיוורים של מחלקות אשפוז. בעיניי, זוהי ההגדרה של חסד טהור, ואני מלא הכרת הטוב על הזכות לעמוד לצדם.',
    author_gony_p2: 'כשחיפשתי איך אני יכול לתרום את חלקי הקטן לעשייה המבורכת הזו, הבנתי שהכלי הפשוט שיש בידיי הוא הסיפור. הספר שלי, "שר הצבא", מספר על לוחם שניצב מול קוסם אפל ועוצמתי. זהו סיפור על מאבק בלתי אפשרי, על כוח רצון ועל היכולת למצוא עוצמה פנימית גם כשהסיכויים נראים קלושים.',
    author_gony_p3: 'בעזרת ה\', כשיש לנו הזדמנות להגיש את הספר לילד בבית חולים, הוא מקבל לרגע משהו מעבר לעולם הרפואי; הוא זוכה לעולם של דמיון. הספר לוקח את הידיים הקטנות האלו, ומטיס אותן הרחק מעבר לחומות המחלקה, אל מחוזות של גבורה. הוא מזכיר להם את הלוחם שבתוכם ומעניק להם עוד קצת כוח לעמוד איתנים במערכה.',
    author_gony_p4: 'התפקיד שלנו הוא רק להיות השליחים הקטנים שנותנים להם כלי לעבור את הימים האלו, מתוך תפילה עמוקה שהספרים והחיוכים האלה ייתנו להם כוח להחזיק מעמד, עד לניצחון האמיתי והשלם.',
    ...
    qr_desc: 'אנחנו מחלקים משחקים, ספרים ואהבה לילדים מאושפזים — מתוך אמונה שכל ילד ראוי לחיוך.',
