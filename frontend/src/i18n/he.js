export default {
    ...
    hero_desc: 'חסדי המלך עוסקת בחלוקת מתנות לילדים, צעצועים וספרים. אנו מחלקים בבתי חולים בכל רחבי הארץ כדי לשמח ילדים מאושפזים ולהחזיר להם את החיוך.',
    ...
    // Footer
    footer_about: 'חסדי המלך עוסקת בחלוקת מתנות לילדים, צעצועים ומשחקים. אנו מחלקים בבתי חולים ברחבי ישראל ומחזירים את החיוך לגיבורים הקטנים.',
    ...
    // AboutSection
    about_mission_desc: 'ילדים מאושפזים מפספסים את הילדות. חסדי המלך עוסקת בחלוקת מתנות לילדים, צעצועים וספרים בבתי חולים ברחבי הארץ. צוות המתנדבים שלנו מחלקים בבתי חולים מדי שבוע כדי להחזיר להם רגעים של שמחה וחיוך.',
