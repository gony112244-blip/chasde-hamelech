                ...
                <div style={s.inner}>
                    ...
                    <Sec title="2. מהות הפעילות">
                        ...
                        <p>
                            ...
                            עדכון תקנון זה, ואינה מוכרת לצרכי מס. אין אפשרות להנפיק אישור מס על תרומה.
                            תרומות כספיות (כגון Bit, PayBox, PayPal או העברה בנקאית) ישמשו לרכישת ציוד
                            ולחלוקה לילדים מאושפזים. האתר אינו גובה כרטיס אשראי ואינו שומר פרטי תשלום —
                            התשלום מתבצע ישירות בין התורם לחשבון הפעילות. דיווח על תרומה באתר הוא
                            הצהרה עצמית של התורם ומאושר ידנית על ידי המנהל.
                        </p>
                        <p>
                            <strong>פעילות מתנדבים וביטוח:</strong> ההתנדבות וההשתתפות בפעילות היוזמה מבוצעות על בסיס התנדבותי אישי. מאחר שהיוזמה אינה מאוגדת כעמותה רשומה כדין, פעיליה ומתנדביה אינם מבוטחים בביטוח מתנדבים מטעם המוסד לביטוח לאומי במסגרת פעילות זו, וכל מתנדב נושא באחריות אישית ובלעדית לשלומו, בריאותו וביטוחו האישי.
                        </p>
                    </Sec>
                    ...
                    <Sec title="4. תכנים שמועלים על-ידי משתמשים">
                        <ul style={s.list}>
                            ...
                            <li>
                                אנו שומרים לעצמנו את הזכות לסרב לפרסם תוכן שאינו הולם את ערכי היוזמה.
                            </li>
                        </ul>
                    </Sec>
                    ...
                    <Sec title="5. תמונות וצילומים">
                        <p>
                            ...
                            אם הנך הורה המזהה ילד ומבקש להסיר תמונה, פנה אלינו דרך{' '}
                    ...
                    <Sec title="6. הגבלת אחריות">
                        ...
                        <p>
                            <strong>אחריות נזיקית ונזקי גוף:</strong> היוזמה, מנהליה ופעיליה אינם נושאים באחריות לכל נזק גוף, נזק לרכוש, או כל נזק ישיר או עקיף אחר שעלול להיגרם למתנדבים, למאושפזים, או לכל צד שלישי אחר במהלך הביקורים בבתי חולים, חלוקת מתנות וצעצועים, או כל פעילות אחרת של היוזמה. כל השתתפות בפעילות נעשית על אחריותו הבלעדית של המשתתף ובהסכמתו המלאה לכללי בתי החולים ולהנחיות הבטיחות, ההיגיינה והרפואה.
                        </p>
                    </Sec>

                    <Sec title="7. קישורים חיצוניים">
                        <p>
                            האתר עשוי להכיל קישורים לאתרים חיצוניים (Bit, PayBox, PayPal וכד׳).
