            ...
            <section style={s.content}>
                <div style={s.inner}>
                    ...
                    <Block title="מה כוללת הנגישות באתר?">
                        <ul style={s.list}>
                            <li>תיוגי <code>alt</code> לתמונות (בשיפור מתמיד)</li>
                            <li>תמיכה בניווט מקלדת ברוב הרכיבים האינטראקטיביים</li>
                            <li>כפתור &ldquo;דלג לתוכן&rdquo; בראש כל עמוד</li>
                            <li>שאיפה לניגודיות צבעים עפ&rdquo;י תקן WCAG 2.1 ברמה AA</li>
                    ...
                    <Block title="תאימות">
                        <p>
                            ...
                            ובהנחיות WCAG 2.1 ברמה AA. ההצהרה אינה מהווה אישור תאימות מלאה —
                            נשמח לקבל פניות לשיפור.
                        </p>
                    </Block>
